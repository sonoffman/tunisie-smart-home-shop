      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div>
            ...
            {/* Contact information with updated phone and email */}
            <div className="mb-6 p-4 bg-gray-50 rounded-lg">
              <h2 className="text-lg font-semibold mb-2">Besoin d'aide?</h2>
              <div className="flex items-center space-x-2 mb-2">
                <Phone size={16} className="text-sonoff-blue" />
                <a href="tel:+21650330000" className="text-sonoff-blue hover:underline">+216 50 330 000</a>
              </div>
              <div className="flex items-center space-x-2">
                <Mail size={16} className="text-sonoff-blue" />
                <a href="mailto:contact@sonoff-tunisie.com" className="text-sonoff-blue hover:underline">contact@sonoff-tunisie.com</a>
              </div>
            </div>
