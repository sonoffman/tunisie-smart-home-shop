                  ...
                  <CardFooter className="flex flex-col space-y-2">
                    <TooltipProvider>
                      <Tooltip>
                        ...
                        <TooltipContent><p>Confirmer et enregistrer votre commande</p></TooltipContent>
                      </Tooltip>
                    </TooltipProvider>
                    <TooltipProvider>
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <Button type="button" variant="outline" className="w-full" onClick={handleContinueShopping}>Continuer mes achats</Button>
                        </TooltipTrigger>
                        <TooltipContent><p>Revenir à la page d'accueil</p></TooltipContent>
                      </Tooltip>
                    </TooltipProvider>
                  </CardFooter>
                </form>
